...
const updateTournamentTeam = new UpdateTournamentTeam(tournamentRepository, registrationRepository, walletRepository, transactionRepo, managerRepository, logger);
