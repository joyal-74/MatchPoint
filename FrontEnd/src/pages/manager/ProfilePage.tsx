                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="hidden lg:block bg-card border border-border rounded-2xl p-2 shadow-sm">
                            <button onClick={() => navigate('/manager/settings')} className="flex items-center gap-3 w-full p-3 text-sm font-medium hover:bg-muted rounded-xl transition-all">
                    ...
                    <div className="lg:col-span-8">
                        <div className="bg-card border border-border rounded-2xl sm:rounded-3xl shadow-sm overflow-hidden flex flex-col">
                            ...
                            <div className="px-5 pt-4 border-b border-border">
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground">Manage your management identity and contact details.</p>
                                    </div>
                            ...
                            <div className="lg:hidden p-4 bg-muted/20 border-t border-border grid grid-cols-2 gap-3">
                                <button onClick={() => navigate('/manager/settings')} className="py-3 text-xs font-bold bg-card border border-border rounded-xl flex items-center justify-center gap-2">
