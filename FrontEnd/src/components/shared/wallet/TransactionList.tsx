                        ...
                        return (
                            <div key={t.id} className="p-5 flex items-center justify-between hover:bg-muted/30 transition-all group">
                                <div className="flex items-center gap-5">
                                    {/* 2. Dynamic Icon Background and Color */}
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            ...
                                            <span className={`text-[10px] font-black uppercase tracking-tighter 
                                                ${t.status === 'success' ? 'text-emerald-500' : 'text-orange-400'}`}>
                                                {t.status}
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div className="text-right">
                                    {/* 4. Amount Colors (Green for Income, Foreground for Expense) */}
                                    <p className={`text-lg font-black tracking-tight ${isIncome ? 'text-emerald-600' : 'text-rose-600'}`}>
