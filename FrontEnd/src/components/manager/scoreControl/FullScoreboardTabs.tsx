        ...
        return (
            <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="text-md">
                        {bowlingStatsArray.map((stat) => {
                            const isCurrentBowler = stat.playerId === inningsData.currentBowler;
                            return (
                                <tr key={stat.playerId} className={`border-b border-neutral-800/50 transition-colors ${isCurrentBowler ? 'bg-red-900/10' : 'hover:bg-neutral-900/20'}`}>
                                    <td className="py-3 px-4">
                                    ...
                                    <td className="py-3 px-2 text-right font-mono text-white">{stat.overs}</td>
            ...
            <div className="p-4 border-b border-neutral-800 flex flex-col sm:flex-row justify-between items-center gap-4 bg-neutral-900/30">
                ...
                <div className="flex bg-neutral-900 p-1 rounded-lg border border-neutral-800">
                    <button
                        ...
                        className={`px-4 py-1.5 rounded-md text-sm font-bold transition-all ${activeInnings === 1 ? 'bg-neutral-800 text-white shadow-sm' : 'text-neutral-500 hover:text-neutral-300'
                            }`}
                    >
                        1st Innings
                    </button>
                    <button
                        ...
                        className={`px-4 py-1.5 rounded-md text-sm font-bold transition-all ${activeInnings === 2 ? 'bg-neutral-800 text-white shadow-sm' : 'text-neutral-500 hover:text-neutral-300'
                            }`}
                    >
                        2nd Innings
                    </button>
