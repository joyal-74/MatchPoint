...
const CurrentMatchState: React.FC<CurrentMatchStateProps> = ({ match, liveScore }) => {
    ...
    if (!currentInnings) return <div className="text-gray-400 p-4">Waiting for innings to start...</div>;
    ...
    const getPlayerName = (playerId: string | null): string => {
        ...
        const player = [...match.teamA.members, ...match.teamB.members].find(p => p._id === playerId);
        return player?.name || 'Unknown';
    };

    const strikerStats = currentInnings.battingStats[currentInnings.currentBatsmanId || ''] || { runs: 0, balls: 0, fours: 0, sixes: 0 };
    const nonStrikerStats = currentInnings.battingStats[currentInnings.nonStrikerId || ''] || { runs: 0, balls: 0, fours: 0, sixes: 0 };
    const bowlerStats = currentInnings.bowlingStats[currentInnings.currentBowlerId || ''] || { 
        overs: 0, maidens: 0, wickets: 0, runsConceded: 0, wides: 0, noBalls: 0 
    };
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 p-6 rounded-xl border border-gray-700 shadow-lg">
            ...
            <div className="mb-6">
                <div className="flex justify-between items-start mb-2">
                    <div>
                        <h3 className="text-lg font-semibold text-gray-300">Live Match</h3>
                        <p className="text-sm text-gray-400"> Match #{match.matchNumber}</p>
                    </div>
                    <div className="text-right">
                        <div className="inline-block px-3 py-1 bg-red-500 rounded-full text-xs font-bold">
                            LIVE
                        </div>
                        <p className="text-sm text-gray-400 mt-1">Innings {liveScore.currentInnings}</p>
                    </div>
                </div>
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg mb-6">
                <div className="flex justify-between items-center mb-4">
                    <div>
                        <div className="text-4xl font-bold text-white">
                            {currentInnings.score}<span className="text-gray-400">/{currentInnings.wickets}</span>
                        </div>
                    ...
                    <div className="text-right">
                        <div className="text-xl font-bold text-blue-400">
                            CRR: <span>{currentInnings.score / (currentInnings.overs + currentInnings.ballsInOver/6) || 0}</span>
                        </div>
                ...
                <div className="grid grid-cols-4 gap-2 text-center">
                    <div className="bg-gray-700/50 p-2 rounded">
                        <div className="text-xs text-gray-400">Wides</div>
                    ...
                    <div className="bg-gray-700/50 p-2 rounded">
                        <div className="text-xs text-gray-400">Leg Byes</div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-gray-800/50 p-4 rounded-lg border-l-4 border-gray-500">
                        <div className="text-sm font-semibold text-gray-400 mb-2">NON-STRIKER</div>
