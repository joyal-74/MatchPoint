...
import { Home, Trophy, Users, User, PlayCircle } from 'lucide-react';
...
const BottomNav: React.FC = () => {
    ...
    const navItems = [
        { name: 'Home', path: '/player/dashboard', icon: Home },
        { name: 'Tournaments', path: '/player/tournaments', icon: Trophy },
        { name: 'Live', path: '/player/live', icon: PlayCircle }, 
        { name: 'Teams', path: '/player/teams', icon: Users },
